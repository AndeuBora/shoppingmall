...
<c:set var="byuList" value="${buyLists.get(i)}"/>
<c:set var="pid" value="${buyLists.getBuy_id( )}"/>
<c:if test="${i+1 >buLists.size() -1 }">
...
<td><fmt:formatNumber value="{buyList.getBuy_price()}" type="number"
pattern="#,##()"/>원</td>
...
<fmt:formatNumber value="${total}" type="number" pattern="#.##()"/>원</td></tr>
<c:set var="total" value="0"/>
